...
class GeneratePackagesNumbersV3Response implements ResultInterface
{
    /**
     ...
     * @return $this
     */
    public function setReturn(PackagesGenerationResponseV2 $return) : GeneratePackagesNumbersV3Response
    {
        $this->return = $return;
