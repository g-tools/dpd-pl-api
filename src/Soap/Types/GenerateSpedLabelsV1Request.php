...
class GenerateSpedLabelsV1Request implements RequestInterface
{
     ...
     * @return $this
     */
    public function setDpdServicesParams(DpdServicesParamsV1 $dpdServicesParamsV1) : GenerateSpedLabelsV1Request
    {
     ...
     */
    public function setOutputDocFormat(OutputDocFormatDSPEnumV1 $outputDocFormatV1) : GenerateSpedLabelsV1Request
    {
     ...
     * @return GenerateSpedLabelsV1Request
     */
    public function setOutputDocPageFormat(OutputDocPageFormatDSPEnumV1 $outputDocPageFormatV1) : GenerateSpedLabelsV1Request
    {
     ...
     * @return GenerateSpedLabelsV1Request
     */
    public function setAuthData(AuthDataV1 $authDataV1) : GenerateSpedLabelsV1Request
    {
