...
class GenerateSpedLabelsV2Response implements ResultInterface
{
     ...
     * @return $this
     */
    public function setReturn(DocumentGenerationResponseV1 $return) : GenerateSpedLabelsV2Response
    {
        $this->return = $return;
        return $this;
    }
