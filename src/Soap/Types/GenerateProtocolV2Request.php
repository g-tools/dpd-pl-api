...
class GenerateProtocolV2Request implements RequestInterface
{
     ...
     */
    public function setDpdServicesParams(DpdServicesParamsV1 $dpdServicesParamsV1) : GenerateProtocolV2Request
    {
     ...
     * @return GenerateProtocolV2Request
     */
    public function setOutputDocFormat(OutputDocFormatDSPEnumV1 $outputDocFormatV1) : GenerateProtocolV2Request
    {
     ...
     * @return GenerateProtocolV2Request
     */
    public function setOutputDocPageFormat(OutputDocPageFormatDSPEnumV1 $outputDocPageFormatV1) : GenerateProtocolV2Request
    {
     ...
     * @return GenerateProtocolV2Request
     */
    public function setAuthData(AuthDataV1 $authDataV1) : GenerateProtocolV2Request
    {
