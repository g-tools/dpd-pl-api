...
class GenerateSpedLabelsV4Request implements RequestInterface
{
     ...
     * @return $this
     */
    public function setDpdServicesParams(DpdServicesParamsV1 $dpdServicesParamsV1) : GenerateSpedLabelsV4Request
    {
     ...
     * @return $this
     */
    public function setOutputDocFormat(OutputDocFormatDSPEnumV1 $outputDocFormatV1) : GenerateSpedLabelsV4Request
    {
     ...
     * @return $this
     */
    public function setOutputDocPageFormat(OutputDocPageFormatDSPEnumV1 $outputDocPageFormatV1) : GenerateSpedLabelsV4Request
    {
     ...
     * @return $this
     */
    public function setOutputLabelType(OutputLabelTypeEnumV1 $outputLabelType) : GenerateSpedLabelsV4Request
    {
     ...
     * @return $this
     */
    public function setLabelVariant(string $labelVariant) : GenerateSpedLabelsV4Request
    {
     ...
     * @return $this
     */
    public function setAuthData(AuthDataV1 $authDataV1) : GenerateSpedLabelsV4Request
    {
