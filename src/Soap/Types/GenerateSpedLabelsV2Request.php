...
class GenerateSpedLabelsV2Request implements RequestInterface
{
     ...
     * @return $this
     */
    public function setDpdServicesParams(DpdServicesParamsV1 $dpdServicesParamsV1) : GenerateSpedLabelsV2Request
    {
     ...
     * @return $this
     */
    public function setOutputDocFormat(OutputDocFormatDSPEnumV1 $outputDocFormatV1) : GenerateSpedLabelsV2Request
    {
     ...
     * @return $this
     */
    public function setOutputDocPageFormat(OutputDocPageFormatDSPEnumV1 $outputDocPageFormatV1) : GenerateSpedLabelsV2Request
    {
     ...
     * @return string
     */
    public function getOutputLabelType() : string
    {
     ...
     * @return $this
     */
    public function setOutputLabelType(string $outputLabelTypeV2) : GenerateSpedLabelsV2Request
    {
     ...
     * @return $this
     */
    public function setAuthData(AuthDataV1 $authDataV1) : GenerateSpedLabelsV2Request
    {
