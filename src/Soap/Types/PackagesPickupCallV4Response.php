...
class PackagesPickupCallV4Response implements ResultInterface
{
     ...
     * @return $this
     */
    public function setReturn(PackagesPickupCallResponseV3 $return) : PackagesPickupCallV4Response
    {
        $this->return = $return;
        return $this;
    }
