...
class GenerateProtocolsWithDestinationsV2Request implements RequestInterface
{
     ...
     * @return $this
     */
    public function setDpdServicesParams(DpdServicesParamsV2 $dpdServicesParamsV2) : GenerateProtocolsWithDestinationsV2Request
    {
     ...
     * @return $this
     */
    public function setAuthData(AuthDataV1 $authDataV1) : GenerateProtocolsWithDestinationsV2Request
    {
